...
def create_langchain_agent(model_name: str):
    ...
    prompt = ChatPromptTemplate.from_messages([
        ...
        1. Carefully review the provided document and website links.
        2. Identify any factually incorrect statements in the document based on the content from the website links.
        3. Provide accurate corrections, each with a brief reason. DO NOT return the links in the corrections.
        4. Focus strictly on verifiable facts — including dates, statistics, historical events, and scientific claims.
        5. Be conservative in your judgment — only flag clear, objective factual inaccuracies, not opinions or subjective language.
